...
function applyVelocityCurve(rawVel, curve) {
  switch (curve) {
    case 'log':
      return Math.pow(rawVel, 0.5); // boost soft hits
    case 'exp':
      return Math.pow(rawVel, 2.0); // only loud hits register
    case 'fixed':
      return 0.8; // always same velocity
    case 'soft':
      return rawVel * 0.5 + 0.1; // low range
    default:
      return rawVel; // linear
  }
}
...
export const NOTE_KEY_OFFSETS = {
  ...
  KeyJ: 11,
  KeyK: 12,
  KeyL: 14, // white: C D E F G A B C' D'
  KeyZ: 1,
  KeyX: 3,
  KeyC: 6,
  KeyV: 8,
...
const PAGE_NAV = {
  KeyQ: { role: 'page', hint: 'PATN' },
  KeyW: { role: 'page', hint: 'ROLL' },
  KeyE: { role: 'page', hint: 'SOUND' },
  KeyR: { role: 'page', hint: 'MIX' },
  KeyT: { role: 'page', hint: 'FX' },
  KeyY: { role: 'page', hint: 'SCENE' },
  KeyU: { role: 'page', hint: 'BANKS' },
  KeyI: { role: 'page', hint: 'ARR' },
  KeyO: { role: 'page', hint: 'SET' },
  KeyP: { role: 'record', hint: 'REC' },
  Space: { role: 'play', hint: 'PLAY' },
  KeyZ: { role: 'oct-shift', hint: 'Oct-' },
  KeyX: { role: 'oct-shift', hint: 'Oct+' },
};

const NUM_ROLES = {
  Digit1: { role: 'track-sel', hint: 'T1' },
  Digit2: { role: 'track-sel', hint: 'T2' },
  Digit3: { role: 'track-sel', hint: 'T3' },
  Digit4: { role: 'track-sel', hint: 'T4' },
  Digit5: { role: 'track-sel', hint: 'T5' },
  Digit6: { role: 'track-sel', hint: 'T6' },
  Digit7: { role: 'track-sel', hint: 'T7' },
  Digit8: { role: 'track-sel', hint: 'T8' },
  Digit9: { role: 'util', hint: 'PANIC' },
  Digit0: { role: 'util', hint: 'MUTE' },
  Minus: { role: 'util', hint: 'BPM-' },
  Equal: { role: 'util', hint: 'BPM+' },
};

const NOTE_ROLES = {
  KeyA: { role: 'note', hint: 'C' },
  KeyS: { role: 'note', hint: 'D' },
  KeyD: { role: 'note', hint: 'E' },
  KeyF: { role: 'note', hint: 'F' },
  KeyG: { role: 'note', hint: 'G' },
  KeyH: { role: 'note', hint: 'A' },
  KeyJ: { role: 'note', hint: 'B' },
  KeyK: { role: 'note', hint: "C'" },
  KeyL: { role: 'note', hint: "D'" },
  KeyZ: { role: 'oct-shift', hint: 'Oct-' },
  KeyX: { role: 'oct-shift', hint: 'Oct+' },
  KeyC: { role: 'note-black', hint: 'F#' },
  KeyV: { role: 'note-black', hint: 'G#' },
  KeyB: { role: 'note-black', hint: 'A#' },
  KeyN: { role: 'note-black', hint: "C#'" },
...
const KEY_ROLES = {
  pattern: {
    ...PAGE_NAV,
    KeyA: { role: 'step', hint: '1' },
    KeyS: { role: 'step', hint: '2' },
    KeyD: { role: 'step', hint: '3' },
    KeyF: { role: 'step', hint: '4' },
    KeyG: { role: 'step', hint: '5' },
    KeyH: { role: 'step', hint: '6' },
    KeyJ: { role: 'step', hint: '7' },
    KeyK: { role: 'step', hint: '8' },
    KeyL: { role: 'step', hint: '9' },
    KeyZ: { role: 'step', hint: '10' },
    KeyX: { role: 'step', hint: '11' },
    KeyC: { role: 'step', hint: '12' },
    KeyV: { role: 'step', hint: '13' },
    KeyB: { role: 'step', hint: '14' },
    KeyN: { role: 'step', hint: '15' },
  ...
  mixer: {
    ...PAGE_NAV,
    KeyA: { role: 'track', hint: 'TRK1' },
    KeyS: { role: 'track', hint: 'TRK2' },
    KeyD: { role: 'track', hint: 'TRK3' },
    KeyF: { role: 'track', hint: 'TRK4' },
    KeyG: { role: 'track', hint: 'TRK5' },
    KeyH: { role: 'track', hint: 'TRK6' },
    KeyJ: { role: 'track', hint: 'TRK7' },
    KeyK: { role: 'track', hint: 'TRK8' },
    KeyL: { role: 'util', hint: 'MUTE' },
    KeyM: { role: 'util', hint: 'SOLO' },
  },
  fx: {
    ...PAGE_NAV,
    KeyA: { role: 'util', hint: 'CLEAN' },
    KeyS: { role: 'util', hint: 'WARM' },
    KeyD: { role: 'util', hint: 'SPACE' },
    KeyF: { role: 'util', hint: 'PUNCH' },
    KeyG: { role: 'util', hint: 'LO-FI' },
  },
  scenes: {
    ...PAGE_NAV,
    KeyA: { role: 'scene', hint: 'SCN1' },
    KeyS: { role: 'scene', hint: 'SCN2' },
    KeyD: { role: 'scene', hint: 'SCN3' },
    KeyF: { role: 'scene', hint: 'SCN4' },
    KeyG: { role: 'scene', hint: 'SCN5' },
    KeyH: { role: 'scene', hint: 'SCN6' },
    KeyJ: { role: 'scene', hint: 'SCN7' },
    KeyK: { role: 'scene', hint: 'SCN8' },
    KeyL: { role: 'util', hint: 'SNAP' },
  },
  banks: {
    ...PAGE_NAV,
    KeyA: { role: 'util', hint: 'BNK A' },
    KeyS: { role: 'util', hint: 'BNK B' },
    KeyD: { role: 'util', hint: 'BNK C' },
    KeyF: { role: 'util', hint: 'BNK D' },
    KeyG: { role: 'util', hint: 'BNK E' },
    KeyH: { role: 'util', hint: 'BNK F' },
    KeyJ: { role: 'util', hint: 'BNK G' },
    KeyK: { role: 'util', hint: 'BNK H' },
  },
  arranger: {
    ...PAGE_NAV,
...
function detectChord(notes) {
  ...
  for (const root of pcs) {
    ...
    for (const { intervals, suffix } of CHORD_PATTERNS) {
      if (intervals.length === normalized.length && intervals.every((iv, i) => iv === normalized[i])) {
...
function renderShortcutGrid(shortcuts, container) {
  ...
  shortcuts.forEach(({ key, action }) => {
    ...
    item.innerHTML = `<kbd class="kbd-key-badge">${key}</kbd>` + `<span class="kbd-shortcut-action">${action}</span>`;
...
export function renderKbdContext(containerEl, page, activeKeys = new Set(), state = null, getActiveTrackFn = null) {
  ...
  QWERTY_ROWS.forEach(({ cls, pad, keys }) => {
    ...
    keys.forEach(({ code, cap, w }) => {
      ...
      keyEl.innerHTML = `<span class="qkey-cap">${cap}</span>` + (hint ? `<span class="qkey-hint">${hint}</span>` : '');
  ...
  if (state && ['sound', 'piano-roll'].includes(page)) {
    ...
    velCurveWrap.style.cssText =
      'display:flex;align-items:center;gap:3px;font-size:0.55rem;color:var(--muted,#888);font-family:var(--font-mono);white-space:nowrap;';
    velCurveWrap.textContent = 'VEL CURVE ';
    const velCurveSelect = document.createElement('select');
    velCurveSelect.style.cssText =
      'font-size:0.55rem;font-family:var(--font-mono);background:var(--bg2,#1a1a1a);color:var(--screen-text,#e0d8c8);border:1px solid var(--muted,#888);border-radius:2px;padding:1px 2px;cursor:pointer;';
    ...
    chordBadge.style.cssText =
      'font-size:0.65rem;font-family:var(--font-mono);color:var(--accent,#f0c640);background:rgba(240,198,64,0.1);border:1px solid var(--accent,#f0c640);border-radius:3px;padding:1px 5px;min-width:36px;text-align:center;display:inline-block;opacity:0.85;';
    ...
    chordMemLabel.style.cssText =
      'font-size:0.6rem;color:var(--muted,#888);font-family:var(--font-mono);margin-right:2px;white-space:nowrap;';
  ...
  octaves.forEach((oct) => {
    WHITE_SEMITONES.forEach((semi) => {
      ...
      if (midi % 12 === 0) {
        ...
        label.style.cssText =
          'position:absolute;bottom:14px;left:50%;transform:translateX(-50%);font-size:0.38rem;color:rgba(0,0,0,0.4);font-family:var(--font-mono);pointer-events:none;';
        k.append(label);
...
export function initKeyboard(state, emit, trackColors = []) {
  ...
  if (kbdPianoEl) {
    ...
    collapseBtn.addEventListener('click', () => {
      ...
      rows?.forEach((r) => {
        r.style.display = state.kbdCollapsed ? 'none' : '';
      });
  ...
  window.addEventListener('keydown', (e) => {
    ...
    if (page === 'piano-roll' || page === 'sound') {
      ...
      if (offset != null) {
        ...
        if (state.splitKeyboard) {
          ...
          state.selectedTrackIndex = midiNote < 60 ? (state.splitTrackLeft ?? 0) : (state.splitTrackRight ?? 1);
        }
        ...
        if (state.keyboardHold) {
          ...
          voicing.forEach((chordOffset) => {
            const chordNote = midiNote + chordOffset;
            if (chordNote >= 0 && chordNote <= 127) _emit('note:preview', { note: chordNote, velocity });
          });
        }
        ...
        {
          const _arpTrack =
            state.project?.banks?.[state.activeBank]?.patterns?.[state.activePattern]?.kit?.tracks?.[
    ...
    if (page === 'mixer') {
      ...
      if (e.code === 'KeyM') {
        emit('track:solo', { trackIndex: state.selectedTrackIndex });
        return;
      }
    }
    ...
    if (page === 'scenes') {
      ...
      if (si >= 0) {
        emit('scene:select', { sceneIndex: si });
        return;
      }
      if (e.code === 'KeyL') {
        emit('scene:snapshot', { sceneIndex: state.activeScene ?? 0 });
        return;
      }
    }
    ...
    if (page === 'arranger') {
      if (e.code === 'KeyL') {
        emit('arranger:addSection', {});
        return;
      }
      if (e.code === 'KeyM') {
        emit('arranger:removeSection', {});
        return;
      }
    }
  ...
  window.addEventListener('keyup', (e) => {
    ...
    if (offset != null && !state.keyboardHold) {
      ...
      voicing.forEach((chordOffset) => {
        const chordNote = midiNote + chordOffset;
        if (chordNote >= 0 && chordNote <= 127) emit('note:off', { note: chordNote });
      });
    }
  });
}
