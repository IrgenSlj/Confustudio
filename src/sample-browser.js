...
export function openSampleBrowser(state, emit, trackIndex) {
  ...
  backdrop.style.cssText =
    'position:fixed;inset:0;background:rgba(0,0,0,0.82);z-index:1000;display:flex;align-items:center;justify-content:center';

  // ── Panel ──
  const panel = document.createElement('div');
  panel.style.cssText =
    'background:#111;border:1px solid #2a2a2a;border-radius:6px;width:480px;max-height:520px;display:flex;flex-direction:column;padding:0';

  // ── Header bar ──
  const header = document.createElement('div');
  header.style.cssText =
    'display:flex;align-items:center;justify-content:space-between;padding:10px 14px;border-bottom:1px solid #2a2a2a;flex-shrink:0';
  ...
  closeBtn.style.cssText =
    'background:none;border:none;color:#888;font-size:1.2rem;cursor:pointer;line-height:1;padding:0 2px';
  ...
  footer.style.cssText =
    'padding:8px 14px;border-top:1px solid #2a2a2a;font-family:monospace;font-size:0.65rem;color:#888;flex-shrink:0';
  ...
  function buildRow(name, size) {
    ...
    previewBtn.style.cssText =
      'background:none;border:1px solid #333;border-radius:3px;color:#f0c640;font-size:0.7rem;cursor:pointer;padding:2px 6px;flex-shrink:0';
    ...
    nameSpan.style.cssText =
      'font-family:monospace;font-size:0.68rem;color:#ccc;flex:1;overflow:hidden;text-overflow:ellipsis;white-space:nowrap';
    ...
    loadBtn.style.cssText =
      'background:#1a1a1a;border:1px solid #333;border-radius:3px;color:#f0c640;font-family:monospace;font-size:0.65rem;cursor:pointer;padding:2px 8px;flex-shrink:0';
